...
extension OctoDog {
    struct Repos {
        ...
        ///
        ///
        func listInvitationsForAuthenticatedUser() -> Response<ListAUserSRepositoryInvitationsResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(ListAUserSRepositoryInvitationsResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        ///
        ///
        func getContributorsStats() -> Response<GetContributorsListWithAdditionsDeletionsAndCommitCountsResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(GetContributorsListWithAdditionsDeletionsAndCommitCountsResponse.self, from: data)
                return Response(body: body, error: nil)
