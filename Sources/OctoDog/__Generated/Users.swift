...
///If the user is not blocked:
      func checkBlocked() -> Response<CheckWhetherYou'VeBlockedAUserResponse> {
        ...
        do {
          let decoder = JSONDecoder()
          let body = try decoder.decode(CheckWhetherYou'VeBlockedAUserResponse.self, from: data)
          return Response(body: body, error: nil)
      ...
      func addEmails() -> Response<AddEmailAddress(Es)Response> {
        ...
        do {
          let decoder = JSONDecoder()
          let body = try decoder.decode(AddEmailAddress(Es)Response.self, from: data)
          return Response(body: body, error: nil)
      ...
      func deleteEmails() -> Response<DeleteEmailAddress(Es)Response> {
        ...
        do {
          let decoder = JSONDecoder()
          let body = try decoder.decode(DeleteEmailAddress(Es)Response.self, from: data)
          return Response(body: body, error: nil)
      ...
      func listFollowersForUser() -> Response<ListAUser'SFollowersResponse> {
        ...
        do {
          let decoder = JSONDecoder()
          let body = try decoder.decode(ListAUser'SFollowersResponse.self, from: data)
          return Response(body: body, error: nil)
      ...
      func listFollowersForAuthenticatedUser() -> Response<ListTheAuthenticatedUser'SFollowersResponse> {
        ...
        do {
          let decoder = JSONDecoder()
          let body = try decoder.decode(ListTheAuthenticatedUser'SFollowersResponse.self, from: data)
          return Response(body: body, error: nil)
