...
extension OctoDog {
    struct Apps {
        ...
        /// Lists installations in a repository that the authenticated user has explicit permission (`:read`, `:write`, or `:admin`) to access.
        ///
        ...
        // https://developer.github.com/v3/apps/marketplace/#list-all-plans-for-your-marketplace-listing
        /// GitHub Apps must use a [JWT](https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://developer.github.com/v3/auth/#basic-authentication) with their client ID and client secret to access this endpoint.
        func listPlansStubbed() -> Response<ListAllPlansForYourMarketplaceListingStubbedResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(ListAllPlansForYourMarketplaceListingStubbedResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        ///
        /// GitHub Apps must use a [JWT](https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://developer.github.com/v3/auth/#basic-authentication) with their client ID and client secret to access this endpoint.
        func listAccountsUserOrOrgOnPlan() -> Response<ListAllGitHubAccountsUserOrOrganizationOnASpecificPlanResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(ListAllGitHubAccountsUserOrOrganizationOnASpecificPlanResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        ///
        /// GitHub Apps must use a [JWT](https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://developer.github.com/v3/auth/#basic-authentication) with their client ID and client secret to access this endpoint.
        func listAccountsUserOrOrgOnPlanStubbed() -> Response<ListAllGitHubAccountsUserOrOrganizationOnASpecificPlanStubbedResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(ListAllGitHubAccountsUserOrOrganizationOnASpecificPlanStubbedResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        ///
        /// GitHub Apps must use a [JWT](https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://developer.github.com/v3/auth/#basic-authentication) with their client ID and client secret to access this endpoint.
        func checkAccountIsAssociatedWithAnyStubbed() -> Response<CheckIfAGitHubAccountIsAssociatedWithAnyMarketplaceListingStubbedResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(CheckIfAGitHubAccountIsAssociatedWithAnyMarketplaceListingStubbedResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        func listMarketplacePurchasesForAuthenticatedUser() -> Response<GetAUserSMarketplacePurchasesResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(GetAUserSMarketplacePurchasesResponse.self, from: data)
                return Response(body: body, error: nil)
        ...
        // https://developer.github.com/v3/apps/marketplace/#get-a-users-marketplace-purchases
        /// Returns only active subscriptions. You must use a [user-to-server OAuth access token](https://developer.github.com/apps/building-github-apps/identifying-and-authorizing-users-for-github-apps/#identifying-users-on-your-site), created for a user who has authorized your GitHub App, to access this endpoint. . OAuth Apps must authenticate using an [OAuth token](https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/).
        func listMarketplacePurchasesForAuthenticatedUserStubbed() -> Response<GetAUserSMarketplacePurchasesStubbedResponse> {
            let data = Data()
            do {
                let decoder = JSONDecoder()
                let body = try decoder.decode(GetAUserSMarketplacePurchasesStubbedResponse.self, from: data)
                return Response(body: body, error: nil)
